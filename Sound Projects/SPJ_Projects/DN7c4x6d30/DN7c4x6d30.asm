...
;----------------------------------------------------------------------------
;PROJECT_ID:	00	<ENTER ID HERE and below>  3/3/23
;   <ROAD> <PRIME MOVER> <CLASS> <MODEL>  	
; 	<h>.SPJ Version 7.0
;BASE CODE:	DN7c4x6d30 -- Discrete Notching,  4 Channel, SDF Version 2.0
...
;----------------------------------------------------------------------------
;    <ROAD> <CLASS> <MODEL> Diesel Electric
;Specifications:
...
;  used for a 16bit premium 8mb sound decoder for a typical diesel locomotive. 
;
;	SLOTS / Channels:
...
;10	Distance Event
;		Grade Crossing
;11	Seconday Mover Sounds (Steam Drift, Diesel Drift)
;12	Idle (not moving)
;		ALCO Stumble
;		AUX and HEP
...
;CV140 PRIME mover Diesel/chuff-exhaust vol 0-64	[50]
...
PROJECT_ID			EQU	000		;cv153	000-254	<ENTER ID HERE>	
;
